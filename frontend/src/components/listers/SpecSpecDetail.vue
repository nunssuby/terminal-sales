<template>
    <v-card outlined>
        ...
        <v-card-text>
            <div>
                <String label="PhoneName" v-model="item.phoneName" :editMode="editMode" @change="change" />
            </div>
            <div>
            ...
            <DetailSpec offline label="DetailSpec" v-model="item.detailSpec" :editMode="false" :key="false" @change="change" />
        </v-card-text>
