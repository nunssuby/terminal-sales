<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <Boolean label="BreakInsurance" v-model="item.breakInsurance" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Boolean label="LostInsurance" v-model="item.lostInsurance" :editMode="editMode" @change="change" />
            </div>
